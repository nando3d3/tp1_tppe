...
public class ClientePrimeTest {
    ...
    public ClientePrimeTest(int id, String cpf_cnpj, String nome, Endereco endereco) {
        this.id = id;
    ...
    public void setup() throws Exception {
        cliente = new ClientePrime(id, cpf_cnpj, nome, endereco);
    }
    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
            {1, "12345678900", "Cliente Prime 1", end1},
            {2, "12345678911", "Cliente Prime 2", end2}
        });
    }
